...
public:
   yield_handler_base(const yield_t &y)
...
public:
   ...
   explicit yield_handler(const yield_t &y)
...
public:
   typedef boost::fibers::asio::detail::yield_handler<void>
       completion_handler_type;
   typedef void return_type;
   typedef boost::fibers::asio::detail::async_result_base base_t;
...
class async_result<boost::fibers::asio::yield_t,
   ...
   : public boost::fibers::asio::detail::async_result_base {
public:
   typedef boost::fibers::asio::detail::yield_handler<Arg2> completion_handler_type;
